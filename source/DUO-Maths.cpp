...
DUO::vector DUO::vector::operator+(vector& vect2) {return DUO::vector(this->getXComponent() + vect2.getXComponent(), this->getYComponent() + vect2.getYComponent());}

DUO::vector DUO::vector::operator-(vector& vect2) {return DUO::vector(this->getXComponent() - vect2.getXComponent(), this->getYComponent() - vect2.getYComponent());}

double DUO::vector::dot(vector& vect) {return (this->getXComponent() * vect.getXComponent()) + (this->getYComponent() * vect.getYComponent());}
